...
{	// click on Application list 
	...
	WebElement elementn = driver.findElement(By.xpath("//*[@id=\"mat-tab-content-0-0\"]/div/div/div[8]/div/div[2]/angular-editor/div/div/div"));
	js.executeScript("arguments[0].click();", elementn);
	elementn.sendKeys("The document has a usability issue where hidden file input .");
	Thread.sleep(1000); 
