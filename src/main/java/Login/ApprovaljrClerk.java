...
{	// click on Application list 
	...
	WebElement de = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-tab-content-0-0\"]/div/div/div[4]/div/div[2]/table/tbody/tr/td[4]/button/span[2]/span")));
	...
	Thread.sleep(3000);
	System.out.println("Approval done by jr clerk 1");
}
@AfterClass            
