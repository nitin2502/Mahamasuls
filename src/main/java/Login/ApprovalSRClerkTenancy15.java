...
public class ApprovalSRClerkTenancy15
{	WebDriver driver;
@BeforeClass
public void setup() {
...
public void testLogin() throws InterruptedException {
	...
	usernameField.sendKeys("9797979797");
	WebElement passwordField = driver.findElement(By.xpath("//input[@placeholder='Password']"));
	passwordField.sendKeys("Aa@146435");
...
{	// click on Application list 
	...
	// click to submit
	WebElement button  = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-tab-content-0-0\"]/div/div/div[11]/div/form/div/div[4]/button/span[2]")));
