...
public class ApprovalTenancyTahsil16
{	WebDriver driver;
@BeforeClass
public void setup() {
...
{	// click on Application list 
	...
	// click to submit
	WebElement button  = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-tab-content-0-0\"]/div/div/div[11]/div/form/div/div[5]/button/span[2]")));
