...
public class ResendApplbyjrClerk 
{	
	WebDriver driver;
@BeforeClass
public void setup() {
...
{	// click on Application list 
	...
	Thread.sleep(1000);
	WebElement option = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-option-19\"]/span")));
	js.executeScript("arguments[0].click();", option);
	Thread.sleep(1000);
	//Resend
	WebElement Resnd = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-mdc-form-field-label-18\"]/mat-label")));
	js.executeScript("arguments[0].click();", Resnd);
	Thread.sleep(1000);
	WebElement Appl = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-option-20\"]/span")));
	js.executeScript("arguments[0].click();", Appl);
	
	
	WebElement elementd = driver.findElement(By.xpath("//input[@formcontrolname='remark']"));
	js.executeScript("arguments[0].click();", elementd);
	elementd.sendKeys("Due to lack of document your Application is rejected");
	Thread.sleep(1000); 
	// Store the current window handle
	String originalWindow = driver.getWindowHandle();

	// Perform actions that open a new window
	WebElement de = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-tab-content-0-0\"]/div/div/div[9]/div/form/div/div[5]/button/span[2]")));
	js.executeScript("arguments[0].click();", de);
	Thread.sleep(1000);
	WebElement ds = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"mat-tab-content-0-0\"]/div/div/div[6]/div/div[2]/table/tbody/tr/td[3]/button/span[2]/span")));
