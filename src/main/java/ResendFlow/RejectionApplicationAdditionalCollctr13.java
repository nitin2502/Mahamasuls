...
public class RejectionApplicationAdditionalCollctr13
{	WebDriver driver;
@BeforeClass
public void setup() {
...
public void testLogin() throws InterruptedException {
	...
	usernameField.sendKeys("9897989897");
	WebElement passwordField = driver.findElement(By.xpath("//input[@placeholder='Password']"));
	passwordField.sendKeys("Aa@130928");
...
{	// click on Application list 
	...
	elementd.sendKeys("Wrong document uploaded");
	Thread.sleep(1000);
